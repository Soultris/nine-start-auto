  ...
  return (
    <div className="w-full flex items-center justify-between font-[montserrat]">
      ...
      <div className="flex flex-col gap-10 max-w-5xl">
        ...
        {/* Feature Boxes Grid */}
        <div className="grid grid-cols-2 max-w-md gap-5">
          {/* 0$ Down Payment */}
          <div className="bg-[#262626] bg-opacity-80 p-5 rounded-2xl flex flex-col items-start">
          ...
          {/* Any Make */}
          <div className="bg-[#262626] bg-opacity-80 p-5 rounded-2xl flex flex-col items-start">
            <CarFront className="w-8 h-8 text-white mb-2" />
